...
function runMigrations() {
  ...
  ensureColumn('projects', 'business_title', 'TEXT');
  ensureColumn('projects', 'business_tagline', 'TEXT');
  ensureColumn('projects', 'business_scenario', 'TEXT');
  ensureColumn('projects', 'business_core_value', 'TEXT');
  ensureColumn('projects', 'business_delivery_form', 'TEXT');
  ensureColumn('projects', 'business_pain_points', "TEXT NOT NULL DEFAULT '[]'");
  ensureColumn('projects', 'business_solution_steps', "TEXT NOT NULL DEFAULT '[]'");
  ensureColumn('projects', 'business_result', 'TEXT');
  ensureColumn('projects', 'business_values', "TEXT NOT NULL DEFAULT '[]'");
  ensureColumn('projects', 'business_contributions', "TEXT NOT NULL DEFAULT '[]'");
  ensureColumn('projects', 'business_audience_focus', "TEXT NOT NULL DEFAULT '[]'");
  ensureColumn('projects', 'business_resource_labels', "TEXT NOT NULL DEFAULT '[]'");
  ensureColumn('projects', 'business_tech_notes', "TEXT NOT NULL DEFAULT '[]'");
